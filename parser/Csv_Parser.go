...
type ClientList struct {
	...
	Membername     string `json:"Member's Name"`
	RegisteredDate string `json:"Recognized Date"`
	Bday           string `json:"Birthday"`
	LengthMembers  string `json:"Length of Membership"`
	BranchCode     string `json:"New Branch Code"`
	Newcid         string `json:"New Customer ID"`
